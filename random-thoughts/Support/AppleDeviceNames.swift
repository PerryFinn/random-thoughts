// Device model mapping derived from BLEUnlock by Takeshi Sone (MIT).
...
let appleDeviceNames = [
    ...
    "iPhone12,8": "iPhone SE", "iPhone10,3": "iPhone X",
    ...
    "iPad3,4": "iPad (4th generation)", "iPad3,5": "iPad (4th generation)",
    "iPad3,6": "iPad (4th generation)", "iPad4,1": "iPad Air",
